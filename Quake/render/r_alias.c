...
//johnfitz -- changed to an array of pointers
...
//johnfitz -- if false, disable vertex shading for various reasons (fullbright, r_lightmap, showtris, etc)
static qboolean shading = true;
